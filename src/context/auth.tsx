...
import { UserRegisterMutation, UserLoginMutation } from "../graphql/mutations";
...
interface State {
  user: Jwtitem | null;
  login: (userData: UserRegisterMutation | UserLoginMutation) => void;
  logout: () => void;
}
...
const initState: State = {
  user: null,
  login: (userData: UserRegisterMutation | UserLoginMutation) => {},
  logout: () => {},
};
...
function AuthProvider(props: Object) {
  ...
  const login = (userData: UserRegisterMutation | UserLoginMutation) => {
